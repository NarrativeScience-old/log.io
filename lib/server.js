...
(function() {
  var LogNode, LogServer, LogStream, WebServer, dgram, events, express, fs, http, https, io, net, winston, _LogObject,
  ...
  */
  ...
  LogServer = (function(_super) {
    ...
    LogServer.prototype.run = function() {
      ...
      return this.udpSocket.on('message', function(message, rinfo) {
        var msg;
        msg = message.toString();
        return _this._handle(_this.udpSocket, msg);
      });
    };
